describe('Unit Test/Model Test', function() {
  ...
  describe('#addOperation API', function() {
    ...
    it.only('raise error when input0 is 1-D tensor for "FULLY_CONNECTED" operation', function() {
      return nn.createModel(options).then((model)=>{
        let batch_size = 3;
        let input_size = 1;
        let num_units = 1;
    ...
    it.only('raise error when the rank of input0 is greater than 4 for "FULLY_CONNECTED" operation', function() {
      return nn.createModel(options).then((model)=>{
        let batch_size = 3;
        let input_size = 1;
        let num_units = 1;
    ...
    it.only('raise error when the type of input0 is not TENSOR_FLOAT32 or TENSOR_QUANT8_ASYMM for "FULLY_CONNECTED" operation', function() {
      return nn.createModel(options).then((model)=>{
        let batch_size = 3;
        let input_size = 1;
        let num_units = 1;
    ...
    it.only('raise error when input0 is a TENSOR_FLOAT32 tensor and input1 is not a TENSOR_FLOAT32 tensor for "FULLY_CONNECTED" operation', function() {
      return nn.createModel(options).then((model)=>{
        let batch_size = 3;
        let input_size = 1;
        let num_units = 1;
    ...
    it.only('raise error when input0 is a TENSOR_QUANT8_ASYMM tensor and input1 is not a TENSOR_QUANT8_ASYMM tensor for "FULLY_CONNECTED" operation', function() {
      return nn.createModel(options).then((model)=>{
        let batch_size = 3;
        let input_size = 1;
        let num_units = 1;
    ...
    it.only('raise error when input0 is a TENSOR_FLOAT32 tensor and input2 is not a TENSOR_FLOAT32 tensor for "FULLY_CONNECTED" operation', function() {
      return nn.createModel(options).then((model)=>{
        let batch_size = 3;
        let input_size = 1;
        let num_units = 1;
    ...
    it.only('raise error when input0 is a TENSOR_QUANT8_ASYMM tensor and input2 is not a TENSOR_INT32 tensor for "FULLY_CONNECTED" operation', function() {
      return nn.createModel(options).then((model)=>{
        let batch_size = 3;
        let input_size = 1;
        let num_units = 1;
    ...
    it.only('raise error when the type of input3 is not INT32 for "FULLY_CONNECTED" operation', function() {
      return nn.createModel(options).then((model)=>{
        let batch_size = 3;
        let input_size = 1;
        let num_units = 1;
    ...
    it.only('raise error when input0 is a TENSOR_FLOAT32 tensor and output is not a TENSOR_FLOAT32 tensor for "FULLY_CONNECTED" operation', function() {
      return nn.createModel(options).then((model)=>{
        let batch_size = 3;
        let input_size = 1;
        let num_units = 1;
    ...
    it.only('raise error when input0 is a TENSOR_QUANT8_ASYMM tensor and output is not a TENSOR_QUANT8_ASYMM tensor for "FULLY_CONNECTED" operation', function() {
      return nn.createModel(options).then((model)=>{
        let batch_size = 3;
        let input_size = 1;
        let num_units = 1;
    ...
    it.only('raise error when input0 TENSOR_QUANT8_ASYMM tensor(RANK <= 4) with its scale being \'input_scale\', input1 as 2-D TENSOR_QUANT8_ASYMM tensor with its scale being \'filter_scale\', input2 as 1-D TENSOR_INT32 tensor with zeroPoint of 0 and its scale being \'bias_scale\' which isn\'t equal to the product of \'input_scale\' and \'filter_scale\' for "FULLY_CONNECTED" operation', function() {
      return nn.createModel(options).then((model)=>{
        let batch_size = 3;
        let input_size = 1;
        let num_units = 1;
    ...
    it.only('raise error when input0 TENSOR_QUANT8_ASYMM tensor(RANK <= 4) with its scale being \'input_scale\', input1 as 2-D TENSOR_QUANT8_ASYMM tensor with its scale being \'filter_scale\', input2 as 1-D TENSOR_INT32 tensor with zeroPoint being not of "0" and its scale being \'bias_scale\' which is equal to the product of \'input_scale\' and \'filter_scale\' for "FULLY_CONNECTED" operation', function() {
      return nn.createModel(options).then((model)=>{
        let batch_size = 3;
        let input_size = 1;
        let num_units = 1;
