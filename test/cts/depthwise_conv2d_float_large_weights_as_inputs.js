describe('Depthwise conv2d float large weights as inputs test', function() {
  ...
  it('check result example 1', async function() {
    ...
    var type3 = {type: nn.TENSOR_FLOAT32, dimensions: [1, 1, 1, 2]};
    var type3_length = product(type3.dimensions);
    var type0 = {type: nn.TENSOR_FLOAT32, dimensions: [1, 2, 2, 2]};
    var type0_length = product(type0.dimensions);
    var type1 = {type: nn.TENSOR_FLOAT32, dimensions: [2]};
