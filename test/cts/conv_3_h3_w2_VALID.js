describe('CTS / Conv 3 h3 w2 valid test', function() {
  ...
  it('check result example 1', async function() {
    ...
    var type2 = {type: nn.TENSOR_FLOAT32, dimensions: [1, 6, 7, 3]};
    ...
    var type3 = {type: nn.TENSOR_FLOAT32, dimensions: [3, 3, 2, 3]};
    var type3_length = product(type3.dimensions);
    var type4 = {type: nn.TENSOR_FLOAT32, dimensions: [3]};
