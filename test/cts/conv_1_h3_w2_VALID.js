describe('CTS / Conv 1 h3 w2 valid test', function() {
  ...
  it('check result example 1', async function() {
    ...
    var type0 = {type: nn.INT32};
    var type3 = {type: nn.TENSOR_FLOAT32, dimensions: [1, 3, 2, 3]};
    var type3_length = product(type3.dimensions);
    var type2 = {type: nn.TENSOR_FLOAT32, dimensions: [1, 6, 7, 1]};
    var type2_length = product(type2.dimensions);
    var type1 = {type: nn.TENSOR_FLOAT32, dimensions: [1, 8, 8, 3]};
    var type1_length = product(type1.dimensions);
    var type4 = {type: nn.TENSOR_FLOAT32, dimensions: [1]};
